...
module.exports = (message) => {
    if (message.author.bot || message.channel.type == "dm" || !message.content.startsWith(Config.Prefix) || message.member.roles.cache.has(Settings.Penals.Jail.Role)) return;
