...
module.exports = {
  ...
  onRequest: async function (client, message, args) {
    ...
    if(!uye) return message.reply(cevaplar.üye + ` \`${sistem.botSettings.Prefixs[0]}${module.exports.Isim} <@sehira/ID> <Isim> <Yaş>\``);
    ...
    if(!isim || !yaş) return message.reply(cevaplar.argümandoldur + ` \`${sistem.botSettings.Prefixs[0]}${module.exports.Isim} <@sehira/ID> <Isim> <Yaş>\``);
...
${isimler}\n\nÜyesinin önceki isimlerine \`${sistem.botSettings.Prefixs[0]}isimler <@sehira/ID>\` komutuyla bakarak kayıt işlemini\n gerçekleştirmeniz önerilir.`
: "." : "."}`)]}).then(msg => {
